...
extension RequestsViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, heightForFooterInSection section: Int) -> CGFloat {
        // Устанавливаем высоту между ячейками
        return Constants.cellMargin
    }
    
    // Если вы используете секции, вам потребуется установить высоту хэдера как 0 для кроме первой секции.
    func tableView(_ tableView: UITableView, heightForHeaderInSection section: Int) -> CGFloat {
        return section == 0 ? 0 : Constants.cellMargin
    }

    func numberOfSections(in tableView: UITableView) -> Int {
        // Вместо одной секции с 10 строками, делаем 10 секций с одной строкой
        return 10
    }

    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        // Теперь в каждой секции будет 1 ячейка
        return 1
    }
